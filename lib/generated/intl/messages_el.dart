...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
          "Το eGestionPOS είναι μια ολοκληρωμένη επιχειρηματική λύση με αποθήκη, λογαριασμό, πωλήσεις, δαπάνες και απώλειες/κέρδη.",
        ),
        ...
        "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
          "Τα χαρακτηριστικά είναι το σημαντικό μέρος που κάνει το eGestionPOS διαφορετικό από τις παραδοσιακές λύσεις.",
        ),
        ...
        "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
          "Η εφαρμογή eGestionPOS είναι δωρεάν και εύκολη στη χρήση. Πράγματι, είναι ένα από τα καλύτερα συστήματα POS σε όλο τον κόσμο.",
        ),
        ...
        "invoiceLogo":
            MessageLookupByLibrary.simpleMessage("Λογότυπο Τιμολογίου"),
        "invoiceNumber":
        ...
        "listIsEmpty":
            MessageLookupByLibrary.simpleMessage("Η Λίστα είναι Άδεια"),
        ...
        "printingOption":
            MessageLookupByLibrary.simpleMessage("Επιλογή Εκτύπωσης"),
        ...
        "salesSetting":
            MessageLookupByLibrary.simpleMessage("Ρυθμίσεις Πωλήσεων"),
        ...
        "shippingCharge":
            MessageLookupByLibrary.simpleMessage("Χρέωση Αποστολής"),
        ...
        "taxRates":
            MessageLookupByLibrary.simpleMessage("Φορολογικοί Συντελεστές"),
