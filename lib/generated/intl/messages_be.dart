...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
          "eGestionPOS з\'яўляецца поўным бізнес-рашэннем са складам, улікам, продажамі, выдаткамі і прыбыткамі/стратамі.",
        ),
        ...
        "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
          "Асаблівасці з\'яўляюцца важнай часткай, якая адрознівае eGestionPOS ад традыцыйных рашэнняў.",
        ),
        ...
        "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
          "Дадатак eGestionPOS бясплатнае і простае ў выкарыстанні. На самай справе, гэта адна з лепшых POS-сістэм у свеце.",
        ),
        ...
        "expiredList":
            MessageLookupByLibrary.simpleMessage("Спіс пратэрмінаваных"),
        ...
        "printingOption":
            MessageLookupByLibrary.simpleMessage("Параметры друку"),
        ...
        "salesSetting":
            MessageLookupByLibrary.simpleMessage("Настройкі продажаў"),
