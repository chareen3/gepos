class BusinessInformationModel {
  BusinessInformationModel({
    ...
    this.user,
    this.invoiceSize,
    this.developedByLevel,
    this.developedBy,
    this.invoiceNote,
    this.companyWebsiteUrl,
    this.postSaleMassage,
  ...
  BusinessInformationModel.fromJson(dynamic json) {
    ...
    developedByLevel = json['develop_by_level'];
    developedBy = json['develop_by'];
    invoiceNoteLevel = json['invoice_note_level'];
    postSaleMassage = json['gratitude_message'];
    companyWebsiteUrl = json['develop_by_link'];
  ...
  String? postSaleMassage;
  String? companyWebsiteUrl;
  String? updatedAt;
  String? invoiceSize;
  Category? category;
  String? developedByLevel;
  String? developedBy;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['gratitude_message'] = postSaleMassage;
    map['develop_by_link'] = companyWebsiteUrl;
    map['develop_by_level'] = developedByLevel;
    map['develop_by'] = developedBy;
